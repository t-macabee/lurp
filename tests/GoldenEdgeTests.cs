...
public sealed class GoldenEdgeTests : InMemoryTestBase
{
    ...
    private static void AssertEdgeContract(EdgeRecord edge, string kind, string provenance, string extractorVersion, string sourceFqnEndsWith)
    {
    ...
    public async Task ExtensionReceiverEdge_ReceiverTypeBindsToExtensionMethod()
    {
        ...
        var receiver = extraction.SingleEdge("ExtensionReceiver", "global::N.Target", "global::N.TargetExtensions.Extend");
