...
internal sealed class CapsuleAnchor
{
    ...
    [JsonPropertyName("scope")] public string Scope { get; init; } = "symbol";

    [JsonPropertyName("intent")] public string Intent { get; init; } = "inspect";
    ...
    [JsonPropertyName("provenance")] public string Provenance { get; init; } = "compiler_proved";

    [JsonPropertyName("extractor_identity")]
    public string ExtractorIdentity { get; init; } = "";

    [JsonPropertyName("locations")] public List<DeclarationLocation> Locations { get; init; } = [];
}
...
internal sealed class CapsuleItem
{
    ...
    [JsonPropertyName("edge_kind")] public string EdgeKind { get; init; }

    [JsonPropertyName("source")] public string? Source { get; init; }

    [JsonPropertyName("document_path")] public string? DocumentPath { get; init; }

    [JsonPropertyName("start_line")] public int? StartLine { get; init; }

    [JsonPropertyName("start_column")] public int? StartColumn { get; init; }

    [JsonPropertyName("end_line")] public int? EndLine { get; init; }

    [JsonPropertyName("end_column")] public int? EndColumn { get; init; }

    [JsonPropertyName("inclusion_reason")] public string? InclusionReason { get; init; }
...
internal sealed record CapsuleConstraint(
    ...
    [property: JsonPropertyName("annotation_kind")]
...
internal sealed class UncertaintyEntry
{
    ...
    [JsonPropertyName("symbol_ids")] public List<string> SymbolIds { get; init; }
...
internal sealed record TokenEstimateAdvisory(
    [property: JsonPropertyName("budget_basis")]
    int BudgetBasis,
    [property: JsonPropertyName("delivery")]
    int Delivery)
{
    [JsonPropertyName("basis")] public static string Basis => "content; per-item identity/provenance framing excluded";

    [JsonPropertyName("window_sizing_field")]
    public static string WindowSizingField => "delivery";
}
...
internal sealed class ContextCapsule
{
    ...
    [JsonPropertyName("direct_callees")] public List<CapsuleItem> DirectCallees { get; init; } = [];

    [JsonPropertyName("direct_callers")] public List<CapsuleItem> DirectCallers { get; init; } = [];

    [JsonPropertyName("registered_implementations")]
    public List<CapsuleItem> RegisteredImplementations { get; init; } = [];

    [JsonPropertyName("relevant_tests")] public List<CapsuleItem> RelevantTests { get; init; } = [];
    ...
    [JsonPropertyName("incoming_paths")] public List<ImpactPath> IncomingPaths { get; init; } = [];

    [JsonPropertyName("outgoing_paths")] public List<ImpactPath> OutgoingPaths { get; init; } = [];

    [JsonPropertyName("constraints")] public List<CapsuleConstraint> Constraints { get; init; } = [];
    ...
    [JsonPropertyName("omitted_tiers")] public List<TruncationEntry> OmittedTiers { get; set; } = [];

    [JsonPropertyName("uncertainties")] public List<UncertaintyEntry> Uncertainties { get; init; } = [];
